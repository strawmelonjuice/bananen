...
released= """""""#
    ...
    if command == "add" || command == "a" {
        ...
        let additiontype = if additiontype == "removal" { "**<span style=\"color: #ff0000\">Removal</span>**" } else if additiontype == "fix" { "**<span style=\"color: #9900cc\">Fix</span>**" } else if additiontype == "addition" { "**<span style=\"color: #336600\">Addition</span>**" } else if additiontype == "update" { "**<span style=\"color: #0033cc\">Update</span>**"} else { &additiontype };
        ...
        let new_md: String = format!(
            "# Changelog\n\n## Unreleased\n\n{newunreleasedchanges}\n\n\n{releasedchanges}\n\n\n<hr>\n\nThis file was auto generated by [<span style=\"background-color: #24273a; color: yellow\">Bananen! 🍌</span>](https://github.com/strawmelonjuice/bananen/) `v{0}`.",
...
released= """{releasedchanges}""""#
    ...
    if command == "regen" || command == "r" {
        ...
        let md: String = format!(
            "# Changelog\n\n## Unreleased\n\n{0}\n\n\n{1}\n\n\n<hr>\n\nThis file was auto generated by [<span style=\"background-color: #24273a; color: yellow\">Bananen! 🍌</span>](https://github.com/strawmelonjuice/bananen/) `v{2}`.",
    ...
    if command == "dub" || command == "d" || command == "push" || command == "bump" {
        ...
        let newreleasedchanges: String = format!("## {releasename}\n\n{0}\n\n{1}",
        _savedata.changes_md.unreleased,
        _savedata.changes_md.released
    );
        let new_md: String = format!(
